...
//     s.add_psCombo(obj);
//     if(makeKeyExample(obj)=="KeyFleeingOnFoot"){
//       if(allComboPoliceData.count("KeyFleeingOnFoot")==0){
//         allComboPoliceData["KeyFleeingOnFoot"] = make_shared<psCombo>(obj->getRegionName(),obj->getState());
//         *allComboPoliceData["KeyFleeingOnFoot"] += s;
        
//       }else{
//         *allComboPoliceData["KeyFleeingOnFoot"] += s;
//       }
//     }else if(makeKeyExample(obj)=="KeyFleeingByCar"){
//       if(allComboPoliceData.count("KeyFleeingByCar")==0){
//         allComboPoliceData["KeyFleeingByCar"] = make_shared<psCombo>(obj->getRegionName(),obj->getState());
//         *allComboPoliceData["KeyFleeingByCar"] += s;
//       }else{
//         *allComboPoliceData["KeyFleeingByCar"] += s;
//       }
//     }else if(makeKeyExample(obj)=="FleeingOtherMeans"){
//       if(allComboPoliceData.count("FleeingOtherMeans")==0){
//         allComboPoliceData["FleeingOtherMeans"] = make_shared<psCombo>(obj->getRegionName(),obj->getState());
//         *allComboPoliceData["FleeingOtherMeans"] += s;
//       }else{
//         *allComboPoliceData["FleeingOtherMeans"] += s;
//       }
//     }else{
//       if(allComboPoliceData.count("NotFleeing")==0){
//         allComboPoliceData["NotFleeing"] = make_shared<psCombo>(obj->getRegionName(),obj->getState());
//         *allComboPoliceData["NotFleeing"] += s;
//       }else{
//         *allComboPoliceData["NotFleeing"] += s;
//       }
//     }
